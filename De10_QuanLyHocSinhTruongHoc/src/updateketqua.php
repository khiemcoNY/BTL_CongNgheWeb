                ...
                <form action="processketqua.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="Up_TenHS" class="form-control" id="exampleInputTenHS"
                            aria-describedby="" placeholder="Enter Ten Học Sinh" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="Up_TenLop" class="form-control" id="exampleInputTenLop"
                            aria-describedby="" placeholder="Enter Tên Lớp">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputDiemVan">Điểm Văn</label>
                        <input type="text" name="Up_DiemVan" class="form-control" id="exampleInputDiemVan"
                            aria-describedby="" placeholder="Enter Diem">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputDiemToan">Điểm Toán</label>
                        <input type="text" name="Up_DiemToan" class="form-control" id="exampleInputDiemToan"
                            aria-describedby="" placeholder="Enter Diem Toan" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputDiemAnh">Điểm Anh</label>
                        <input type="text" name="Up_DiemAnh" class="form-control" id="exampleInputDiemAnh"
                            aria-describedby="" placeholder="Enter Diem Anh" >
                    </div>
                    <div class="form-group">

                        <label for="exampleInputDiemLy">Điểm Lý</label>
                        <input type="text" name="Up_DiemLy" class="form-control" id="exampleInputDiemLy"
                            aria-describedby="" placeholder="Enter Diem Ly" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputDiemHoa">Điểm Hóa</label>
                        <input type="text" name="Up_DiemHoa" class="form-control" id="exampleInputDiemHoa"
                            aria-describedby="" placeholder="Enter Diem Hoa" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputDiemSinh">Điểm Sinh</label>
                        <input type="text" name="Up_DiemSinh" class="form-control" id="exampleInputDiemSinh"
